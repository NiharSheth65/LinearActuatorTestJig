...
void runStateMachine() {
    switch(systemState) {
        ...
        case BACKDRIVE_TEST_STEP2:
          ...
          Serial.println("BACKDRIVE_FORCE_FINAL: " + String(liveForce)); 
        ...
        case BACKDRIVE_TEST_STEP3:
            ...
            if(abs(backdriveFinalPos - backdriveInitialPos) > 5 && peakBackdriveForce < 70 ){
